...
`XPath`更多其他用法, 可以去[w3school](http://www.w3school.com.cn/xpath/xpath_syntax.asp)查看 至此, 可以完成解析`html`并转成`model`的步骤, 接下来的开发就和常规开发模式相同了, 在次不再赘述.
